            ...
            <div>
                    <div className="page-sidebar" style={{width: 270}}>
                        <div className="main-header-left d-none d-lg-block">
                            <div className="logo-wrapper"><Link to="/dashboard"><img className="blur-up lazyloaded" src="./images/crm_logo.png" alt="logo" style={{height:"50px", marginLeft:"20px",width:"130px"}} /></Link></div>
                        </div>
